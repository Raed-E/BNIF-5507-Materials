...
2. **What specific things did you ask them to do?** (Be specific)
   ...
   _I used ChatGPT to help me resolve issues I was having with cloning the assignment repository from Github, installing packages related to the assignment and importing modules from other folders in the assignment notebook. ________________________________________________________________
...
3. **How much of your final code came from AI vs. your own work?** (e.g., "AI gave me the formula, I wrote the loop" or "AI helped me debug an error")
   ...
   _I wrote the code for the assignment, AI helped me diagnose which modules to import in my notebook to be allowed to use functions from other folders in the assignment.________________________________________________________________
...
4. **Can you explain your code?** (Can you walk through what each function does and why you wrote it that way?)
   ...
   __X___ Mostly, but I have some questions
